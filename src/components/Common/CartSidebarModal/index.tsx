...
const CartSidebarModal = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-99999 w-full h-screen bg-dark/70 backdrop-blur-sm transition-opacity duration-200 ${
        isCartModalOpen
    ...
    >
      <div className="flex items-center justify-end">
        <div
          className={`w-full max-w-[500px] h-screen overflow-y-auto no-scrollbar shadow-1 bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content transition-transform duration-300 ${
        ...
        >
          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
            <div className="flex items-center justify-between gap-5 mb-6">
              ...
              <p className="font-medium text-xl text-dark whitespace-nowrap">{totalPrice} DA</p>
            </div>
            ...
            <div className="flex items-center gap-4">
              <Link
                onClick={() => closeCartModal()}
                href="/cart"
                className="w-full flex items-center justify-center font-medium text-white bg-gradient-to-r from-blue to-[#6677ff] py-[13px] px-6 rounded-full shadow-2 transition hover:brightness-110"
              >
                View Cart
              </Link>
