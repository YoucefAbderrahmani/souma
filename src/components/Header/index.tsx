                ...
                <div className="flex items-center">
                  ...
                  >
                    ...
                    <button
                      ...
                      id="search-btn"
                      aria-label="Search"
                      className="flex items-center justify-center absolute right-3 top-1/2 -translate-y-1/2 ease-in duration-200 hover:text-[#FB923C]"
                    >
                      <svg
                  ...
                  <div className="flex min-w-0 items-center gap-2 sm:gap-3">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="font-medium text-custom-sm text-dark truncate max-w-[120px] sm:max-w-[160px]">
              ...
              <ThemeToggle />
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-[#FB923C] w-4.5 h-4.5 rounded-full text-white">
                      {totalItems}
                    </span>
                  </span>
