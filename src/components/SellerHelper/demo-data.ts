...
export const DEMO_SECURITY_THREAT_TYPES = {
  ...
  items: [
    { label: "Bot scraping", pct: 62 },
    { label: "Erreurs JS", pct: 38 },
  ],
} as const;
...
export const DEMO_SECURITY_INCIDENTS = [
  ...
  },
  {
    ...
    category: "Erreurs JS",
    riskScore: 85,
    title: "Erreurs JavaScript répétées (5 signaux)",
    detail: "pa_js_error sur la fiche produit et le tunnel de conversion",
    ip: "203.0.113.78",
    location: "Inconnu",
