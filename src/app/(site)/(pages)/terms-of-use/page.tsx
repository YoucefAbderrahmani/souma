...
export const metadata: Metadata = {
  title: "Terms of Use | Vitrina Store",
  description: "Vitrina Store website and service terms.",
};
        ...
        <div className="mx-auto w-full max-w-[1170px] px-4 sm:px-8 xl:px-0">
          <div className="rounded-xl bg-white p-6 shadow-1 sm:p-10">
            ...
            <p className="mt-4 text-dark-4">
              By using Vitrina Store, you agree to our terms covering account usage, order processing,
