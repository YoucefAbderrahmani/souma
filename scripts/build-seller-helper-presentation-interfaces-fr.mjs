/**
 * Rapport PDF — Présentation des interfaces Seller Helper (script oral FR)
 *
 *   node scripts/build-seller-helper-presentation-interfaces-fr.mjs --html-only
 *   node scripts/build-seller-helper-presentation-interfaces-fr.mjs --pdf
 */
...
const SRC_MD = path.join(ROOT, "reports", "Seller-Helper-Presentation-Interfaces-fr.md");
const OUT_HTML = path.join(ROOT, "reports", "Seller-Helper-Presentation-Interfaces-fr.html");
const OUT_PDF = path.join(ROOT, "reports", "Seller-Helper-Presentation-Interfaces-fr.pdf");
...
<title>Seller Helper — Guide de présentation des interfaces</title>
<style>
  :root {
    --ink: #1a1a1a;
    --muted: #5c5c5c;
...
<body>
  <section class="cover">
    <p class="cover-kicker">Vitrina Store · Seller Helper · Soutenance</p>
    <h1>Guide de présentation — chaque interface du Seller Helper</h1>
    <p>Ce qu&apos;expliquer à l&apos;écran et <strong>ce que dire à l&apos;oral</strong> pour les 9 onglets, le bandeau global et le scénario de démo.</p>
  ...
  <main class="body">
    ${bodyHtml}
    <p class="colophon">Source : <code>reports/Seller-Helper-Presentation-Interfaces-fr.md</code> · Script : <code>scripts/build-seller-helper-presentation-interfaces-fr.mjs</code></p>
  </main>
</body>
</html>`;
}
