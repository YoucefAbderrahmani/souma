/**
 * Rapport PDF — Guide technique Seller Helper + questions jury (présentation)
 *
 *   node scripts/build-seller-helper-technical-jury-guide-fr.mjs --html-only
 *   node scripts/build-seller-helper-technical-jury-guide-fr.mjs --pdf
 */
...
const SRC_MD = path.join(ROOT, "reports", "Seller-Helper-Technical-Jury-Guide-fr.md");
const OUT_HTML = path.join(ROOT, "reports", "Seller-Helper-Technical-Jury-Guide-fr.html");
const OUT_PDF = path.join(ROOT, "reports", "Seller-Helper-Technical-Jury-Guide-fr.pdf");
...
<title>Seller Helper — Guide technique &amp; questions jury</title>
<style>
  :root {
    --ink: #1a1a1a;
    --muted: #5c5c5c;
...
<body>
  <section class="cover">
    <p class="cover-kicker">Vitrina Store · Seller Helper · Documentation technique &amp; soutenance</p>
    <h1>Fonctionnement technique du Seller Helper et guide de questions jury</h1>
    <p>Architecture, flux de données, micro-événements, APIs, onglets, Vitrina, sécurité, timeline, IA, e-mail — avec réponses types pour la présentation.</p>
    <div class="cover-meta">
      <p><strong>Projet :</strong> USTHB — Faculté d'Informatique — 2025 / 2026</p>
      <p><strong>Généré le :</strong> ${escapeHtml(generatedAt)}</p>
    </div>
  </section>
  <main class="body">
    ${bodyHtml}
    <p class="colophon">Source : <code>reports/Seller-Helper-Technical-Jury-Guide-fr.md</code> · Script : <code>scripts/build-seller-helper-technical-jury-guide-fr.mjs</code></p>
  </main>
</body>
</html>`;
}
