/**
 * Builds the academic-graduation report
 *   "Seller Helper — A Smart Decision-Support Companion for Small E-commerce Sellers"
 * (HTML + PDF), modelled on the USTHB graduation reports.
 *
 * The report focuses on functionalities, market study, UX, validation
 * and results; technical depth is concentrated in a single chapter
 * (Implémentation et Réalisation).
 *
 *   node scripts/build-seller-helper-graduation-report.mjs          (HTML only)
 *   node scripts/build-seller-helper-graduation-report.mjs --pdf    (HTML + PDF, requires Playwright)
 */
...
const OUT_HTML = path.join(ROOT, "reports", "Seller-Helper-Graduation-Report.html");
const OUT_PDF = path.join(ROOT, "reports", "Seller-Helper-Graduation-Report.pdf");

const META = {
  university: "University of Sciences and Technology Houari Boumediene",
  faculty: "Faculty of Computer Science",
  framework: "Graduation Project — Vitrina Store",
  theme:
    "Design and deployment of a smart decision-support companion (\"Seller Helper\") for small online sellers, grafted on the Vitrina Store e-commerce platform.",
  supervisor: "Dr. — Graduation project supervisor",
  team: [
    "Vada Abderrahmani — Project lead",
    "Vitrina Store graduation team",
  ],
  academicYear: "2025 / 2026",
  title: "Seller Helper — A Smart Decision-Support Companion for Small E-commerce Sellers",
};
...
<body>
  ...
  <main class="body">
    ${bodyHtml}
    <p class="colophon">Generated ${escapeHtml(generatedAt)} · Source: <code>reports/Seller-Helper-Graduation-Report.md</code> · Pipeline: <code>scripts/build-seller-helper-graduation-report.mjs</code>.</p>
  </main>
</body>
</html>`;
}
  ...
  try {
    ...
    if (error && error.code === "EBUSY") {
      ...
      outputPath = path.join(
        ...
        `Seller-Helper-Graduation-Report-${stamp}.pdf`
      );
